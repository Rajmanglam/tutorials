# Suppose you have a folder, and its path is also given. You have
...
# file is present in a dictionary file then it will not capitalize the first
# letter. It will only capitalize the first letter of the files, which are not
# present in the dictionary file.
# The function renames the file names to number in range of 1 to100 whose format
# is the same as mentioned in the input parameter like 1.jpg.